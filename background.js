...
chrome.action.onClicked.addListener((tab) => {
  ...
  if (!tab.url.includes("youtube.com/watch")) {
    ...
    chrome.notifications.create({
      ...
      message: 'Please navigate to a YouTube video page to use the transcript feature.'
    });
    return;
  }
...
chrome.runtime.onInstalled.addListener((details) => {
  if (details.reason === 'install') {
    ...
    console.log('YouTube Transcript Extractor updated to version', chrome.runtime.getManifest().version);
  }
});